...
ARS corpus is composed of 3 experimental settings according to conversation lengths. 
"""

# Length-5
tf.compat.v1.flags.DEFINE_string("train_file", "./data/emnlp2016/5_train.json",
                                 "path to train file")
tf.compat.v1.flags.DEFINE_string("valid_file", "./data/emnlp2016/5_dev.json",
                                 "path to valid file")
tf.compat.v1.flags.DEFINE_string("test_file", "./data/emnlp2016/5_test.json",
                                 "path to test file")
tf.compat.v1.flags.DEFINE_integer("max_seq_length", 120,
                                  "max sequence length of concatenated context and response")
tf.compat.v1.flags.DEFINE_integer("max_utr_num", 5,
                                  "Maximum utterance number.")
tf.compat.v1.flags.DEFINE_string("vocab_file", "./uncased_L-12_H-768_A-12/vocab.txt",
                                 "path to vocab file")
tf.compat.v1.flags.DEFINE_bool("do_lower_case", True,
...
# Length-10
tf.compat.v1.flags.DEFINE_string("train_file", "./data/emnlp2016/10_train.json",
                                 "path to train file")
tf.compat.v1.flags.DEFINE_string("valid_file", "./data/emnlp2016/10_dev.json",
                                 "path to valid file")
tf.compat.v1.flags.DEFINE_string("test_file", "./data/emnlp2016/10_test.json",
                                 "path to test file")
tf.compat.v1.flags.DEFINE_integer("max_seq_length", 220,
                                  "max sequence length of concatenated context and response")
tf.compat.v1.flags.DEFINE_integer("max_utr_num", 10,
                                  "Maximum utterance number.")
tf.compat.v1.flags.DEFINE_string("vocab_file", "./uncased_L-12_H-768_A-12/vocab.txt",
                                 "path to vocab file")
tf.compat.v1.flags.DEFINE_bool("do_lower_case", True,
...
# Length-15
tf.compat.v1.flags.DEFINE_string("train_file", "./data/emnlp2016/15_train.json",
                                 "path to train file")
tf.compat.v1.flags.DEFINE_string("valid_file", "./data/emnlp2016/15_dev.json",
                                 "path to valid file")
tf.compat.v1.flags.DEFINE_string("test_file", "./data/emnlp2016/15_test.json",
                                 "path to test file")
tf.compat.v1.flags.DEFINE_integer("max_seq_length", 320,
                                  "max sequence length of concatenated context and response")
tf.compat.v1.flags.DEFINE_integer("max_utr_num", 15,
                                  "Maximum utterance number.")
tf.compat.v1.flags.DEFINE_string("vocab_file", "./uncased_L-12_H-768_A-12/vocab.txt",
                                 "path to vocab file")
tf.compat.v1.flags.DEFINE_bool("do_lower_case", True,
...
tf.compat.v1.flags.DEFINE_string("train_file", "./data/stac2016/train.json",
                                 "path to train file")
tf.compat.v1.flags.DEFINE_string("valid_file", "./data/stac2016/dev.json",
                                 "path to valid file")
tf.compat.v1.flags.DEFINE_string("test_file", "./data/stac2016/test.json",
                                 "path to test file")
tf.compat.v1.flags.DEFINE_integer("max_seq_length", 230,
                                  "max sequence length of concatenated context and response")
tf.compat.v1.flags.DEFINE_integer("max_utr_num", 7,
...
"""Li et al., 2020. Molweni: A challenge multiparty dialogues-based machine reading comprehension dataset with 
discourse structure."""

tf.compat.v1.flags.DEFINE_string("train_file", "./data/molweni2020/train.json",
                                 "path to train file")
tf.compat.v1.flags.DEFINE_string("valid_file", "./data/molweni2020/dev.json",
                                 "path to valid file")
tf.compat.v1.flags.DEFINE_string("test_file", "./data/molweni2020/test.json",
                                 "path to test file")
tf.compat.v1.flags.DEFINE_integer("max_seq_length", 230,
                                  "max sequence length of concatenated context and response")
tf.compat.v1.flags.DEFINE_integer("max_utr_num", 7,
