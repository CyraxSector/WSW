# coding=utf-8
"""WSW testing runner on the downstream task of reply utterance selection."""
...
def run_test(dir_path, op_name, sess, training, accuracy, prob, pair_ids):
    ...
    try:
        while True:
            step += 1
            batch_accuracy, predicted_prob, batch_pair_ids = sess.run([accuracy, prob, pair_ids],
            ...
            if step % 100 == 0:
                tf.compat.v1.logging.info("n_update %d , %s: Mins Used: %.2f" %
